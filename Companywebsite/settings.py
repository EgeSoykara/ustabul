...
try:
    ...
    SHORT_NOTE_MAX_CHARS = 100
SHORT_NOTE_MAX_CHARS = max(20, min(240, SHORT_NOTE_MAX_CHARS))
# Reliability
...
MOBILE_PUSH_ANDROID_CHANNEL_ID = os.getenv("MOBILE_PUSH_ANDROID_CHANNEL_ID", "ustabul_general").strip() or "ustabul_general"
...
WORKFLOW_EVENT_RETENTION_DAYS = int(os.getenv("WORKFLOW_EVENT_RETENTION_DAYS", "30"))
...
MESSAGE_RETENTION_DAYS = int(os.getenv("MESSAGE_RETENTION_DAYS", "45"))
