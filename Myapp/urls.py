...
urlpatterns = [
    ...
    path('api/mobile-shell/context/', views.mobile_shell_context, name='mobile_shell_context'),
    path('api/mobile-shell/devices/register/', views.mobile_shell_register_device, name='mobile_shell_register_device'),
    path('api/mobile-shell/devices/unregister/', views.mobile_shell_unregister_device, name='mobile_shell_unregister_device'),
